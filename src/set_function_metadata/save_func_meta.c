...
int main(int argc, char * argv[]){
	...
	// for now test, 5 embed, 5 rms_norm fwd, 7 rms_norm bwd x, 7 rms norm bwd w, 5 rope, 3 rope bwd, 5 copy seq to context, 5 swiglu fwd, 7 swiglu bwd, 7 softmax, 3 cross entropy
	int total_native_functions = 59;
	...
	char * kernel_pre_strings[11] = {"embedding", "rms_norm", "rms_norm_bwd_x", "rms_norm_bwd_w", "rope", "rope_bwd_x", "copy_to_seq_context", "silu_hadamard", "silu_hadamard_bwd_x", "softmax", "cross_entropy_loss"};
	char * kernel_post_strings[11] = {"kernel", "kernel", "kernel", "kernel", "kernel", "kernel", "kernel", "kernel", "kernel", "kernel", "kernel"};
	char * kernel_set_attribute_symbols[11] = {NULL, "rms_norm_set_attribute_config", "rms_norm_set_attribute_config", "rms_norm_set_attribute_config", NULL, NULL, NULL, NULL, NULL, NULL, NULL};
	char * kernel_set_launch_symbols[11] = {"embedding_set_launch_config", "rms_norm_set_launch_config", "rms_norm_bwd_x_set_launch_config", "rms_norm_bwd_w_set_launch_config", 
	...
	for (int i = 0; i < 5; i++){
		...
		set_native_embedding_skeleton(cur_op_skeleton, fwd_datatypes[i]);
