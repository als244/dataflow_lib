...
int submit_rope(Dataflow_Handle * handle, int stream_id, 
	...
	set_native_rope_skeleton(&rope_op.op_skeleton, fwd_dt);
...
int submit_rope_bwd_x(Dataflow_Handle * handle, int stream_id, 
	...
	set_native_rope_bwd_x_skeleton(&rope_bwd_op.op_skeleton, bwd_dt);
...
int submit_copy_to_seq_context(Dataflow_Handle * handle, int stream_id, 
	...
	set_native_copy_to_seq_context_skeleton(&copy_to_seq_contrxt_op.op_skeleton, fwd_dt);
