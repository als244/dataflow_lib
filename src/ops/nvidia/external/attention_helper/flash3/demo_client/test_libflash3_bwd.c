...
int reserve_dev_memory(int total_q, int total_k, int num_seqs, size_t x_dt_bytes, 
				...
				void ** cu_seqlens_q, int max_seqlen_q,
				void ** cu_seqlens_k, int max_seqlen_k,
...
int load_and_copy_sample_inputs(char * data_dir, int num_seqs, int total_q, int total_k, int model_dim, int kv_dim, int dtype_size, void * cu_seqlens_q, void * cu_seqlens_k, void * x_q, void  * x_k, void * x_v, void * dx_out){
	...
	sizes[5] = (total_q * model_dim * dtype_size);
...
int main (int argc, char * argv[]){
	...
	ret = load_and_copy_sample_inputs(data_dir, num_seqs, total_q, total_k, model_dim, kv_dim, x_dt_bytes, cu_seqlens_q, cu_seqlens_k, x_q, x_k, x_v, dx_out);
	if (ret){
