...
extern "C" __global__ void softmax_fp16_to_fp32_kernel(int n_cols, __half * X_in, float * out, uint32_t * arg_maxs) {
...
extern "C" __global__ void softmax_bf16_to_fp32_kernel(int n_cols, __nv_bfloat16 * X_in, float * out, uint32_t * arg_maxs) {
