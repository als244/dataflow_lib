...
inline float solo_bf16_to_fp32(uint16_t a) {
...
inline uint16_t solo_fp32_to_bf16(float f) {
	uint32_t bits;
...
inline float solo_fp16_to_fp32(uint16_t h) {
...
inline uint16_t solo_fp32_to_fp16(float f) {
	uint32_t x;
	memcpy(&x, &f, sizeof(x));
...
inline uint16_t solo_fp16_to_bf16(uint16_t h) {
...
inline uint16_t solo_bf16_to_fp16(uint16_t a) {
